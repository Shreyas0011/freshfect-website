    ...
    <section id="products" class="reveal">
        ...
        <div class="about-container" style="background: white; padding: 60px; border-radius: 40px; box-shadow: var(--shadow-premium); border: 1px solid var(--glass-border); margin-top: 40px;">
            ...
            <div class="about-text">
                ...
                <div class="price" style="font-size: 2.2rem; margin: 20px 0; color: var(--accent-green); font-family: 'Outfit', sans-serif; font-weight: 700;">₹299.00</div>
        ...
        <div class="product-grid reveal" style="display: flex; flex-wrap: wrap; justify-content: center; gap: 40px;">
            <div class="product-card" style="flex: 1; min-width: 300px; max-width: 600px;">
                <div class="product-badge" style="background: var(--accent-green); color: white;">Best Value</div>
                ...
                <div class="price" style="font-size: 2.2rem; color: var(--accent-green); font-weight: 700;">₹1,299.00 <span style="font-size: 1.2rem; color: #999; text-decoration: line-through;">₹1,495.00</span></div>
                <p style="margin-top: 10px; font-size: 1.1rem;">Stock up on high-performance cleaning. Five identical sachets of our signature All Cleaner formula — delivered right to your door in Mumbai.</p>
                <div class="product-footer" style="margin-top: 30px;">
                    <a href="https://wa.me/911234567890?text=Hi%20Freshfect!%20I'd%20like%20to%20order%20the%20Pack%20of%205%20Bundle." target="_blank" class="cta-btn-primary" style="display: block; text-align: center; border-radius: 100px;">
